<img src="logo/logo.png" alt="RustOtomeLab Logo" width="256">
...
> [!IMPORTANT]
> このリポジトリにはテスト用シーンスクリプトファイルとその他のテストファイルが含まれています。もちろん独自のテストファイルを準備することも可能です。ファイルの要件については上記の2つのドキュメントを参照してください。
